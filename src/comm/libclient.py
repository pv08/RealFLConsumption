...
class Message:
    ...
    def _write(self):
        if self._send_buffer:
            # log(INFO, f"Sending buffer of {len(self._send_buffer)} to {self.addr}")
            try:
    ...
    def process_jsonheader(self):
        ...
        if len(self._recv_buffer) >= hdrlen:
            self.jsonheader = self._pickle_decode(
    ...
    def process_response(self):
        ...
        if self.jsonheader["content-type"] == "binary/pickle":
